...
<body>
	...
	name="frm">
		...
		<table>
			<tr>
				<th>사진</th>
				<td ><input type="file" name="filename" accept=".jpg,.png,.gif">
				<span style="color: red; font-size: 12px">확장자'jpg/png/gif'만 가능합니다.</span></td>
			</tr>
			<tr>
				<th>*ID</th>
				<td><input type="text" name="id" size="20">
				<button type="button" onclick="idCheck(document.frm.id.value)">ID중복확인</button>
				<span style="color: red; font-size: 12px">*필수입력입니다.</span>
				</td>
			</tr>
			<tr>
				<th>*비밀번호</th>
			...
			<TR>
				<TH>*비밀번호확인</TH>
				<TD><input type="password" name="repasswd" size="20">
				<span style="color: red; font-size: 12px">*필수입력입니다.</span>
				</TD>
			...
			<TR>
				...
				<input type="text" name="address1" size="30" placeholder="주소" id="sample6_address" style="margin-bottom:5px " ><br>
				<input type="text" name="address2" size="30" placeholder="상세주소" id="sample6_address2" >
					</TD>
					<td></td>
			</TR>
